...
public interface PedidoRepository extends JpaRepository<Pedido, Long> {
    ...
    * List<Pedido> findPedidosByFilters(@Param("fechaInicio") LocalDate
    * fechaInicio, @Param("fechaFin") LocalDate fechaFin, @Param("estado") String
    * estado, @Param("documento") String documento);
    */
   @Query("SELECT p FROM Pedido p " +
   ...
   @Query("SELECT p FROM Pedido p WHERE p.fueExportado = false")
   List<Pedido> findByFueExportadoFalse();
}
